...
class BestPromptPipeline:
    ...
    def load_prediction_from_file(self, seed_number):
        prediction, gold_labels = get_prediction_from_file(self.target_path, seed_number)
...
def get_result_file_path(dataset_name, model_name, fewshots, target_path, template_name):
    ...
    if fewshots:
        ...
        shot = 'zero'
    file_name = f'{target_path}/{dataset_name}_{model}_{template_name}_{shot}'
    return file_name
...
def write_prediction_to_file(result_tuple, result_path, seed_number):
